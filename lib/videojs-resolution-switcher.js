/*! videojs-resolution-switcher - 2018-11-27
  ...
  (function(window, videojs) {
	  ...
	  var ResolutionMenuButton = videojs.extend(MenuButton, {
	      constructor: function(player, options){
	        ...
	        this.el_.setAttribute('aria-label','Quality');
	        this.controlText('Quality');
	        
	        if(options.dynamicLabel){
	          videojs.dom.addClass(this.label, 'vjs-resolution-button-label');
	          this.menuButton_.el_.appendChild(this.label);
	        }else{
	          var staticLabel = document.createElement('span');
	           videojs.dom.addClass(staticLabel, 'vjs-menu-icon');
	           this.menuButton_.el_.appendChild(staticLabel);
	        }
	  ...
	  videoJsResolutionSwitcher = function(options) {
	      ...
	      function initResolutionForYt(player){
	        ...
	        var _yts = {
	          res4k: {res: 2160, label: '4k', yt: '4k'},
	          highres: {res: 1440, label: '1440', yt: 'highres'},
